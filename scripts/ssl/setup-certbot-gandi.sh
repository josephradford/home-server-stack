...
dns_gandi_token = $GANDIV5_PERSONAL_ACCESS_TOKEN
EOF
...
echo ""
echo "Next steps:"
echo "  Run the full SSL setup (copies certs, configures Traefik, sets up renewal):"
echo "    make ssl-setup"
echo ""
echo "  Or run individual steps manually:"
echo "  1. Copy certificates to Traefik directory:"
echo "     ./scripts/ssl/copy-certs-to-traefik.sh"
echo ""
echo "  2. Configure Traefik to use file provider:"
echo "     ./scripts/traefik/configure-traefik-file-provider.sh"
echo ""
echo "  3. Set up automatic cert renewal:"
echo "     ./scripts/ssl/setup-cert-renewal.sh"
echo ""
echo "Certificate renewal:"
echo "  - Certificates auto-renew via snap (certbot renew runs twice daily)"
echo "  - To test renewal: make ssl-renew-test"
echo ""
